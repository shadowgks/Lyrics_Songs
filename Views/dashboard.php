...
<body class="dark:text-white dark:bg-gray-900">
    ...
    <aside class="fixed top-0 left-0 w-64 h-full hidden lg:block lg:w-2/12 z-50" aria-label="Sidenav" id="mobile-menu">
                    ...
                    <form>
                        ...
                        <div class="relative">
                            ...
                            <input type="search" id="default-search"
                                class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500"
                                placeholder="Search Mockups, Logos..." required />
                            <button type="submit"
                                class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">
                                Search
                            </button>
                        </div>
                    </form>
        ...
        <div
            class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white border-gray-200 dark:bg-gray-800 z-20">
            <a href="#"
        ...
        <section class="p-5 sm:p-10">
            ...
            <div>
                <div class="lg:text-end lg:block grid">
                    <div>
                        <h1
                            class="mb-4 text-4xl font-extrabold text-gray-900 md:text-4xl lg:text-5xl dark:text-white text-center md:text-start">
                            CLIENTS
                        </h1>
                        <hr
